    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <motion.div
          ...
          className="bg-white dark:bg-gray-800 py-8 px-4 shadow-xl rounded-2xl sm:px-10"
        >
          {/* User Type Selection */}
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                <User className={`w-6 h-6 mx-auto mb-2 ${
                  userType === 'user' ? 'text-primary-600' : 'text-gray-400'
                }`} />
                <div className={`text-sm font-medium ${
                  userType === 'user' ? 'text-primary-600' : 'text-gray-700 dark:text-gray-300'
                }`}>
                  Book Services
                </div>
              ...
              >
                <Wrench className={`w-6 h-6 mx-auto mb-2 ${
                  userType === 'provider' ? 'text-primary-600' : 'text-gray-400'
                }`} />
                <div className={`text-sm font-medium ${
                  userType === 'provider' ? 'text-primary-600' : 'text-gray-700 dark:text-gray-300'
                }`}>
                  Provide Services
                </div>
                <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">
